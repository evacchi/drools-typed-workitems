install:
	...
	cd jbpm/jbpm-workitems/ &&   mvn install -DskipTests -Denforcer.skip
	cd kie-wb-common/kie-wb-common-stunner/kie-wb-common-stunner-sets/kie-wb-common-stunner-bpmn/ && mvn install -DskipTests -Denforcer.skip
